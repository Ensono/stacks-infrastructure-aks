...
The resultant script will be created in `./.eirctl/envvar-azure-dev.sh`. The naming convention is `envvar-<CLOUD>-<STAGE>.sh`.
...
[source,bash]
----
source ./.eirctl/envvar-azure-dev.sh
----
