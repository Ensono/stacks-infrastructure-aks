...
module "aks_bootstrap" {
  source = "git::https://github.com/Ensono/stacks-terraform//azurerm/modules/azurerm-aks?ref=v8.0.14"
  ...
  dns_parent_resource_group = var.dns_parent_zone_resource_group
