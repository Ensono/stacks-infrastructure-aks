...
output "certificate_pem" {
  ...
  value       = var.create_ssl_gateway ? module.ssl_app_gateway[0].certificate_pem : null
  sensitive   = true
}

output "issuer_pem" {
  description = "PEM key of certificate, can be used internally together certificate to create a full cert"
  value       = var.create_ssl_gateway ? module.ssl_app_gateway[0].issuer_pem : null
  sensitive   = true
}

output "app_gateway_resource_group_name" {
  description = "Resource group of the Application Gateway"
  value       = var.create_ssl_gateway ? module.ssl_app_gateway[0].app_gateway_resource_group_name : ""
}

output "app_gateway_name" {
  description = "Name of the Application Gateway"
  value       = var.create_ssl_gateway ? module.ssl_app_gateway[0].app_gateway_name : ""
}
...
output "app_gateway_ip" {
  ...
  value       = var.create_ssl_gateway ? module.ssl_app_gateway[0].app_gateway_ip : ""
}
