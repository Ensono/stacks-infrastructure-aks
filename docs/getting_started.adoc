...
If using Bash, you can use the `eirctl run setup:environment` command to automatically generate an environment variable script from the `build/config/stage_envvars.yml` configuration file.
