module "ssl_app_gateway" {
  source                       = "git::https://github.com/Ensono/stacks-terraform//azurerm/modules/azurerm-app-gateway?ref=v8.0.32"
  ...
  aks_ingress_ip               = var.internal_ingress_enabled ? local.aks_ingress_private_ip : module.aks_bootstrap.aks_ingress_public_ip
